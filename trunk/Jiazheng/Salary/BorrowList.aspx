<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BorrowList.aspx.cs" Inherits="Jiazheng.Salary.BorrowList" %>
    ...
    <table width="98%" border="0" cellpadding="2" cellspacing="1" align="center" class="list">
        ...
        <asp:Repeater ID="list" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center">
                        <%# Eval("BorrowTime").ToDateTime().ToString("yyyy-MM-dd")%>
                    </td>
                    <td align="center">
                        <%# Eval("BorrowMoney")%>
                    </td>
                    <td align="center">
                        <%if (SysPartRole.AllowEdit == true)
                          { %>
                        <a href="BorrowEdit.aspx?id=<%#Eval("id")%>">编辑</a> |
                        <%} %>
        ...
        <tr bgcolor="#FAFAF1">
            <td colspan="7" height="28">
                &nbsp;
                <input id="Button1" type="button" value="新增" onclick="location.href='BorrowEdit.aspx'"
                    class="coolbg" />
