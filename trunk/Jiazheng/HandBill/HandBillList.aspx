<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HandBillList.aspx.cs" Inherits="Jiazheng.HandBill.HandBillList" %>
            ...
            <tr>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <%if (SysPartRole.AllowEdit == true)
                                  { %>
                                <a href="HandBillEdit.aspx?id=<%#Eval("id")%>">编辑</a> |
                                <%} %>
                ...
                <tr bgcolor="#FAFAF1">
                    <td colspan="8" height="28">
                        &nbsp;
                        <input id="Button1" type="button" value="新增" onclick="location.href='HandBillEdit.aspx'"
                            class="coolbg" />
