<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ToolList.aspx.cs" Inherits="Jiazheng.Business.ToolList" %>
    ...
    <table width="98%" border="0" cellpadding="2" cellspacing="1" align="center" class="list">
                ...
                <tr>
                    ...
                    <td align="center">
                        <%if (SysPartRole.AllowEdit == true)
                          { %>
                        <a href="ToolEdit.aspx?id=<%#Eval("id")%>">编辑</a> |
                        <%} %>
        ...
        <tr bgcolor="#FAFAF1">
            <td colspan="3" height="28">
                &nbsp;
                <input id="Button1" type="button" value="新增" onclick="location.href='ToolEdit.aspx'"
                    class="coolbg" />
