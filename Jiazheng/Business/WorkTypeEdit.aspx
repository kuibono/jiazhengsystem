<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkTypeEdit.aspx.cs" Inherits="Jiazheng.Business.WorkTypeEdit" %>
    ...
    <table align="center" border="0" cellpadding="4" cellspacing="1" class="edittable">
        ...
        <tr class="itemrow">
            <td colspan="2">
                ...
                &nbsp;
                <asp:Button ID="btn_Return" runat="server" Text="返回" OnClientClick="location.href='ZWorkTypeList.aspx';return false;" />
            </td>
        </tr>
    </table>
    </form>
